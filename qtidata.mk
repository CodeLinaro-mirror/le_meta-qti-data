...
ifeq ($(BOARD),sdx35)
	...
	QTIDATA+= ipanat ipacm kmod-dataipa kmod-datarmnet kmod-ioss kmod-emac_ioss kmod-gsb kmod-rtsp_alg datafactory kmod-r8125 avahi-nodbus-daemon kmod-r8125_ioss kmod-sfe kmod-aqc_ioss
endif
