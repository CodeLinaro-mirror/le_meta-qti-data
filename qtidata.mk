...
ifeq ($(BOARD),sdx35)
	...
	QTIDATA+= kmod-dataipa kmod-datarmnet kmod-data-devicetree ipanat ipacm ipa-kernel-tests datafactory avahi-nodbus-daemon hostap phytool zonedetect ianatzdata eth-qos eth-cfg set_eth_perf thermal-eth-netlink locationdb nanopb kmod-datarmnet-ext kmod-ioss kmod-emac_ioss
	QTIDATA512M:=kmod-dataipa ipacm ipa-kernel-tests rmnetctl libpugixml kmod-datarmnet kmod-data-devicetree
endif
ifneq ($(PRPL_VERSION),)
