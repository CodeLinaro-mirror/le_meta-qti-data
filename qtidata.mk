...
ifeq ($(BOARD),sdx35)
	...
	QTIDATA512M:=kmod-dataipa ipacm rmnetctl libpugixml kmod-datarmnet
        ...
        QTIDATA+= kmod-dataipa ipanat ipacm kmod-datarmnet datafactory avahi-nodbus-daemon thermal-eth-netlink hostap phytool zonedetect locationdb ianatzdata eth-qos kmod-smem-mailbox kmod-data-devicetree kmod-ioss kmod-emac_ioss kmod-rtl8125 kmod-r8125_ioss eth-cfg set_eth_perf kmod-qca-nss-sfe kmod-qca-nss-ecm-premium
