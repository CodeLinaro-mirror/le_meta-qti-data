...
ifeq ($(BOARD),sdx35)
	...
	QTIDATA512M:=kmod-dataipa ipacm rmnetctl libpugixml kmod-datarmnet
        ...
        QTIDATA+= kmod-dataipa ipanat ipacm kmod-datarmnet datafactory avahi-nodbus-daemon thermal-eth-netlink hostap phytool zonedetect locationdb ianatzdata eth-qos
endif
