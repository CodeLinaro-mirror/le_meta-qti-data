...
ifeq ($(BOARD),sdx35)
	...
	QTIDATA+= kmod-dataipa kmod-datarmnet kmod-data-devicetree ipanat ipacm ipa-kernel-tests datafactory hostap phytool zonedetect ianatzdata eth-qos eth-cfg set_eth_perf thermal-eth-netlink locationdb nanopb kmod-datarmnet-ext kmod-ioss kmod-emac_ioss
