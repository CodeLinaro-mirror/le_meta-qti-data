...
do_install() {
    ...
    cp ${UNPACKDIR}/datarmnet/core/rmnet_core.ko ${DEPLOY_DIR_IMAGE}/kernel_modules/datarmnet

    # Strip debug symbols
    ${STRIP} --strip-debug \
    ${UNPACKDIR}/datarmnet/core/rmnet_core.ko
    ...
    ${STAGING_KERNEL_BUILDDIR}/certs/signing_key.x509 ${UNPACKDIR}/datarmnet/core/rmnet_core.ko
    install -m 0755 ${UNPACKDIR}/datarmnet/core/rmnet_core.ko -D ${D}/usr/lib/modules/${KERNEL_VERSION}/extra/rmnet_core.ko

    #Install startup scripts
    install -d ${D}${sysconfdir}/initscripts/
    install -m 0555 ${UNPACKDIR}/sa535m/start_rmnetcore_le ${D}${sysconfdir}/initscripts/start_rmnetcore_le
    install -d ${D}${systemd_unitdir}/system/
    install -m 0644 ${UNPACKDIR}/sa535m/rmnetcore.service -D ${D}${systemd_unitdir}/system/rmnetcore.service
