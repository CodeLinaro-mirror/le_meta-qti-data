...
SRC_URI  = "git://git.codelinaro.org/clo/le/platform/external/hostap.git;protocol=http;branch=upstream/main"
SRCREV = "ca8c2bd28ad53f431d6ee60ef754e98cfdb4c17b"

# Use upstream as fallback
MIRRORS += "git://git.codelinaro.org/clo/le/platform/external/hostap.git;protocol=http;branch=upstream/main git://w1.fi/hostap.git;protocol=http;branch=main \n "
