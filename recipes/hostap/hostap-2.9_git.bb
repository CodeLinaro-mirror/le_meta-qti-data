...
SRC_URI  = "git://w1.fi/hostap.git;protocol=https"
SRCREV = "ca8c2bd28ad53f431d6ee60ef754e98cfdb4c17b"

# Use CAF mirror as fallback
MIRRORS += "git://w1.fi/hostap.git;protocol=https git://source.codeaurora.org/quic/le/platform/external/hostap.git;protocol=https;branch=upstream/master"
