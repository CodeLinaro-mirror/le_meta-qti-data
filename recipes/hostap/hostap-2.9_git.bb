...
EXTRA_OECONF_append = "--with-sanitized-headers=${STAGING_INCDIR}/linux-msm/usr/include"
...
do_configure() {
  ...
  cp ${STAGING_INCDIR}/linux-msm/usr/include/linux/if_macsec.h ${WORKDIR}/recipe-sysroot/usr/include/linux/if_macsec.h
}
