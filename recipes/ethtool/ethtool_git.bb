...
#SRC_URI = "git://git.kernel.org/pub/scm/network/ethtool/ethtool.git;protocol=https"
SRC_URI = "${GIT_URI}/platform/external/ethtool;protocol=${PROTOCOL};branch=${BRANCH_PREFIX}korg/master"
