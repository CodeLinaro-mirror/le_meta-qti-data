...
#SRC_URI = "git://git.kernel.org/pub/scm/network/ethtool/ethtool.git;protocol=git;branch=master"
SRC_URI = "${CLO_LE_GIT}/platform/external/ethtool;protocol=git;branch=caf_migration/korg/master"
