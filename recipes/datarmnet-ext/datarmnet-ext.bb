...
SRC_URI += "file://start_rmnetsch_le"
SRC_URI += "file://rmnetsch.service"
...
do_compile() {
	...
	ROOTDIR=${WORKSPACE}/ \
	MODULE_OUT=${WORKDIR}/datarmnet-ext/sch-out \
...
do_install() {
    ...
    cp ${WORKDIR}/datarmnet-ext/sch-out/rmnet_sch.ko ${DEPLOY_DIR_IMAGE}/kernel_modules/datarmnet-ext

    # Strip debug symbols
    ${STRIP} --strip-debug \
    ${WORKDIR}/datarmnet-ext/sch-out/rmnet_sch.ko
    ...
    ${STAGING_KERNEL_BUILDDIR}/certs/signing_key.x509 ${WORKDIR}/datarmnet-ext/sch-out/rmnet_sch.ko
    install -m 0755 ${WORKDIR}/datarmnet-ext/sch-out/rmnet_sch.ko -D ${D}/usr/lib/modules/${KERNEL_VERSION}/extra/rmnet_sch.ko

    #Install startup scripts
    install -d ${D}${sysconfdir}/initscripts/
    install -m 0755 ${WORKDIR}/start_rmnetsch_le ${D}${sysconfdir}/initscripts/start_rmnetsch_le
    install -d ${D}${systemd_unitdir}/system/
    install -m 0644 ${WORKDIR}/rmnetsch.service -D ${D}${systemd_unitdir}/system/rmnetsch.service
